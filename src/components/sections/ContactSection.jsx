...
export default function ContactSection({ id }) {
  ...
  const contacts = [
    ...
    },
    {
      ...
      subValue: "Registre a sua reclamação ou sugestão",
    ...
    {
      id: "observatorio",
      label: "Dados e Pesquisas",
      value: "Observatório do Turismo",
      subValue: "Acesse painéis, boletins e pesquisas sobre as festividades e o turismo em PE",
        ...
        <FadeIn className="hc-card bg-white rounded-[2.5rem] md:rounded-[4rem] p-8 md:p-20 shadow-2xl shadow-blue-900/5 border border-white relative overflow-hidden">
          ...
          <div className="text-center mb-12 md:mb-16 relative z-10">
            ...
            <p className="text-slate-500 text-base md:text-lg max-w-xl mx-auto font-light leading-relaxed">
              Estamos à disposição para esclarecimentos. Exerça o seu direito cidadão e acesse os canais oficiais de transparência.
            </p>
          </div>
