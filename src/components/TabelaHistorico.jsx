        ...
        <div className="p-6 border-b border-slate-50 bg-[#0B2341] shrink-0 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            <button 
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-white hover:text-emerald-700 text-white text-xs font-black uppercase tracking-widest rounded-xl transition-all duration-300 shadow-lg shadow-emerald-900/20 active:scale-95 group"
            >
