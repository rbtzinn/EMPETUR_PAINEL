...
import PrivacidadeModal from './PrivacidadeModal'; // <-- IMPORTANDO O MODAL AQUI

export default function Footer() {
  const [isPrivacidadeOpen, setIsPrivacidadeOpen] = useState(false); // Estado para abrir/fechar
  ...
  return (
    <>
      {/* Renderiza o modal (só vai aparecer na tela se isPrivacidadeOpen for true) */}
      <PrivacidadeModal 
