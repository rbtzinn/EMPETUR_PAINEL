      ...
      <FadeIn className="relative w-full max-w-md">
        <Card className="rounded-[2.5rem] border-none shadow-2xl bg-white p-8 md:p-10 flex flex-col items-center text-center">
          ...
          <Text className="text-slate-500 leading-relaxed mb-8">
            Você está prestes a gerar um relatório com <strong className="text-[#0B2341]">{totalRegistros} registros</strong>.<br/><br/>
            Apenas os dados visíveis sob seus filtros serão exportados.
          </Text>
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full">
            ...
            <button onClick={() => { onConfirm(); onClose(); }} className="flex-1 px-6 py-3 rounded-xl bg-[#00AEEF] text-white font-black uppercase tracking-wider shadow-lg shadow-[#00AEEF]/20 hover:bg-[#0B2341] transition-all active:scale-95">
              Gerar Relatório
            </button>
          </div>
        </Card>
