      ...
      <FadeIn className="relative w-full max-w-md">
        <Card className="rounded-[2.5rem] border-none shadow-2xl bg-white p-8 md:p-10 flex flex-col items-center text-center">
          ...
          <Text className="text-slate-500 leading-relaxed mb-8 text-sm">
            O arquivo contém <strong>todos os registros contábeis brutos</strong> do e-Fisco.<br/><br/>
            Ele possui mais linhas que o painel, pois inclui notas estornadas ou duplicidades que nosso sistema já limpou.
          </Text>
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full">
            ...
            <a href={baseBrutaUrl} download="base_bruta_empetur.xlsx" onClick={onClose} className="flex-1 px-6 py-3 rounded-xl bg-[#00AEEF] text-white font-black uppercase tracking-wider shadow-lg shadow-[#00AEEF]/20 hover:bg-[#0B2341] transition-all active:scale-95 flex items-center justify-center">
              Baixar Arquivo
            </a>
          </div>
        </Card>
