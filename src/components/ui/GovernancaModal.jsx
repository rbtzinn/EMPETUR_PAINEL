...
import FadeIn from "./FadeIn"; // Estão na mesma pasta (ui)
    ...
    <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 md:p-6">
      ...
      <FadeIn className="relative w-full max-w-3xl bg-white rounded-[2rem] shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        <div className="bg-[#0B2341] p-6 md:p-8 flex items-center justify-between shrink-0">
          <div>
            <h2 className="text-2xl md:text-3xl font-black text-white mb-1">Motor de Governança de Dados</h2>
        ...
        <div className="p-6 md:p-8 overflow-y-auto scrollbar-moderna text-slate-600 space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
              ...
              <p className="text-xs leading-relaxed">Notas de empenho que foram estornadas, anuladas ou que possuem <strong>R$ 0,00</strong> de valor liquidado são bloqueadas automaticamente antes de entrarem na contagem do painel.</p>
            </div>
            ...
            <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
              ...
              <p className="text-xs leading-relaxed">Corrigimos divergências de digitação humana. Abreviações como <em>"Belém de São Fco"</em> ou erros como <em>"Cumbuca"</em> são normalizados para os nomes oficiais dos municípios. O mesmo vale para os nomes das bandas.</p>
            </div>
            ...
            <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
              ...
              <p className="text-xs leading-relaxed">Como não existe uma coluna separada para "Data do Show" ou "Nome da Banda" na base bruta, nosso algoritmo lê o texto longo do contrato e <strong>extrai cirurgicamente</strong> a data real da apresentação e o nome do artista.</p>
            </div>
            ...
            <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
              ...
              <p className="text-xs leading-relaxed">Para evitar inflar os números de shows, o sistema gera uma <strong>Chave de Identidade Única</strong> (Artista + Cidade + Data + Valor). Se o governo emitir duas notas para o mesmo evento, o painel contabiliza apenas uma apresentação.</p>
            </div>
          </div>
        </div>

        <div className="bg-slate-50 p-6 border-t border-slate-100 shrink-0">
          <button onClick={onClose} className="w-full py-4 rounded-xl bg-[#00AEEF] hover:bg-[#0B2341] text-white font-black uppercase tracking-widest transition-colors shadow-lg">
            Entendi
          </button>
        </div>
      </FadeIn>
