    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl transform transition-all flex flex-col items-center text-center animate-in fade-in zoom-in duration-200">
        ...
        <div className="flex gap-3 w-full">
          ...
          <button onClick={onConfirm} className="flex-1 px-4 py-3 bg-[#00AEEF] hover:bg-[#089bd3] text-white text-sm font-black uppercase tracking-wider rounded-xl transition-colors shadow-lg shadow-blue-500/30">
            Continuar
          </button>
        </div>
      </div>
