...
export default function IndicadoresKPI({ filtrados, filtros, setFiltros }) {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 mb-8 w-full">
      ...
      {/* Card 2: Artistas Diferentes (Estático, sem destaque) */}
      <Card className="flex-1 w-full rounded-3xl border-none shadow-xl shadow-blue-900/5 bg-white flex flex-col justify-center hc-kpi-card">
