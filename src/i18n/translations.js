export const translations = {
  pt: {
    ...
    dashboard: {
      ...
      table: {
        ...
        export: "Exportar Painel",
        searchPlaceholder: "Pesquisar registro...",
        headers: {
  ...
  en: {
    ...
    hero: {
      badge: "Active Transparency • State Law No. 16.790/2019",
    ...
    glossary: {
      ...
      terms: [
        ...
        },
        {
          ...
          description:
            "The state's major celebration periods, such as Carnival, São João, and Pernambuco Meu País, widely supported by EMPETUR.",
        },
        {
    ...
    contact: {
      ...
      contacts: [
        ...
        },
        {
          id: "hours",
          label: "Hours",
          value: "Monday to Friday • 8 AM to 5 PM",
